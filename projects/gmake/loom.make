...
ifeq ($(config),debug_x86)
  ...
  TARGET = $(TARGETDIR)/libloomd.so
  OBJDIR = obj/x86/debug/loom
  DEFINES += -DOS_LINUX -DDEBUG -DLOOM_DLL
...
ifeq ($(config),release_x86)
  ...
  TARGET = $(TARGETDIR)/libloom.so
  OBJDIR = obj/x86/release/loom
  DEFINES += -DOS_LINUX -DNDEBUG -DLOOM_DLL
  INCLUDES += -I../../include -I../../mn/include
  FORCE_INCLUDE +=
  ALL_CPPFLAGS += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
